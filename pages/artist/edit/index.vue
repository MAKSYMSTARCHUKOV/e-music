        ...
        <div class="media section d-flex flex-column">
          ...
          <transition-group name="specs" mode="out-in" appear>
            ...
            >
              ...
              <div
                :key="`${e.title}-${ind}`"
                class="media-item d-flex w-100 mb-5 genre"
              >
                <div
...
export default {
  mixins: [shared, register, spec, price, performer, mounted, edit],
    ...
    return app.$profile
      ...
      .then((r) => {
        ...
        if (app.$isEmpty(r.data.fields.confirmed.value.value)) {
          if (route.name !== 'artist-register')
            redirect({ name: 'artist-register' });
        }
        return {
